		...
		<FormControl>
			<Card mb='20px' {...rest}>
				...
				<SimpleGrid columns={{ sm: 1, md: 2 }} spacing={{ base: '20px', xl: '20px' }}>
					<InputField mb='0px' me='30px' id='username' label='Username' placeholder='@BullFolio.web' />
					<InputField mb='0px' id='email' label='Email Address' placeholder='mail@BullFolio.com' />
